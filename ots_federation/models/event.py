# ots_federation/models/event.py
# Bundled from taky.cot.models.event (taky-federation branch, commit e12a2af).
...
class Event:
    """CoT event object. Parsed from XML or constructed directly."""
        ...
        try:
            for child in elm.iterchildren():
                if child.tag == "point":
                    ...
                    d_tags = {d_elm.tag for d_elm in child.iterchildren()}
