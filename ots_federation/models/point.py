# ots_federation/models/point.py
# Bundled from taky.cot.models.point (taky-federation branch, commit e12a2af).
...
class Point:
    """CoT <point> element. WGS84 lat/lon/hae, circular/linear error in meters."""
